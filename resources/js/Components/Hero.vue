        ...
        <div
            ...
            <div class="w-full md:w-2/3 flex flex-col items-center text-center">
                <h1
                    ...
                    Top jobs in the industry</h1>
                <p class="mb-8 leading-relaxed">Whether you're looking to move
                    to a new role or just seeing what's available, we've
                    gathered this comprehensive list of open positions from a
                    variety of companies and locations for you to choose from.
                </p>
                <form class="flex w-full justify-center items-end"
                ...
                <p class="text-sm mt-2 text-gray-500 mb-8 w-full">fullstack php,
                    vue and node, react native</p>
            </div>
        </div>
    </section>
</template>
